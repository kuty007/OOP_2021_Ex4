...
pok = load_pokemon_list(
    '{"Pokemons":[{"Pokemon":{"value":5.0,"type":-1,"pos":"35.197656770719604,32.10191878639921,0.0"}}]}', graph)
agent = load_agents_list(
    '{"Agents":[{"Agent":{"id":0,"value":0.0,"src":0,"dest":-1,"speed":1.0,"pos":"35.18753053591606,32.10378225882353,0.0"}}]}')

ag = agent[0]
po = pok[0]
print(ag.time_to_pokemon_src(graph, po))
l = [ag]
x = ag
print(l.index(x))
pos = Position()
x = Pokemon(graph)
x.node_src = po.node_src
x.node_src = po.node_src
x.node_dest = po.node_dest
x.pos = po.pos
print(x == po)
print(graph.nodes[0]['pos'])
